...
def create_table_and_insert_data(folder_path):
    try:
        ...
        if connection.is_connected():
            ...
            cursor.execute("SELECT file_path FROM genome_files")
            ...
            if new_files:
                insert_query = "INSERT INTO genome_files (file_path, file_name) VALUES (%s, %s)"
            ...
            if files_to_remove:
                delete_query = "DELETE FROM genome_files WHERE file_path = %s"
...
# Main function
def main():
    folder_path = r'C:\Users\mrnaj\OneDrive\Desktop\whole genome'
